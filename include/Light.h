...
class Light
{
  public:
	...
	//used to see if light will interact with query point q
	//returns true if it will, false otherwise
	//mainly for Spotlight
	virtual bool doesLightInteract(const Eigen::Vector3d & q) const = 0;
